...
export default defineComponent({
  ...
  methods: {
    ...
    /**
     * Method to upload users artwork, returning error messages based on file format & max file size.
     * @param artwork - Artwork file to be uplaoded.
     */
  ...
  computed: {
    /**
     * Computed property to return partners' username.
     */
    partnerUsername() {
